...
protected:
  ...
  public:
    ...
    static typename Listener::Ptr
    createListener(boost::shared_ptr<DispatcherBase> dispatcher,
                   const Callable &callable) {
...
public:
  ...
  typename Listener::Ptr
  createListener(const K &key, const typename BaseClass::Callable &callable) {
