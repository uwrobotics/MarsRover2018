...
SensorData::SensorData(uint8_t limitSwitchSize, uint8_t currentSensorSize,
                       uint8_t thermistorSize) {
...
void SensorData::setScienceContainer(science_msgs::UVSensor sensor,
                                     uint8_t id) {
  if (id == 3) {
...
std::vector<float> SensorData::getThermistors(void) { return thermistors_; }
