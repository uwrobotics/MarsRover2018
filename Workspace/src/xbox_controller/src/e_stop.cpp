...
/* 
This node implements an emergency stop. When a certain set of buttons are pressed on the joystick
duration the autonomy mode, it sends twist messages with veolicty 0 to stop the robot. When another
...
int EmergencyStop::get_rate () const{
	return rate;
}
