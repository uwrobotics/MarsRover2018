...
struct TeleopTwistJoy::Impl
{
  ...
  std::string pub[2]; // = {"turtlesim1/turtle1/cmd_vel", "turtlesim2/turtle1/cmd_vel"};
...
TeleopTwistJoy::TeleopTwistJoy(ros::NodeHandle* nh, ros::NodeHandle* nh_param)
{
  ...
  // add string values in pub
  pimpl_->pub[0] = "/turtlesim1/turtle1/cmd_vel";
  pimpl_->pub[1] = "/turtlesim2/turtle1/cmd_vel";

  pimpl_->cmd_vel_pub = nh->advertise<geometry_msgs::Twist>("/turtlesim2/turtle1/cmd_vel", 1, true);
  pimpl_->joy_sub = nh->subscribe<sensor_msgs::Joy>("drive_joy", 1, &TeleopTwistJoy::Impl::joyCallback, pimpl_);
