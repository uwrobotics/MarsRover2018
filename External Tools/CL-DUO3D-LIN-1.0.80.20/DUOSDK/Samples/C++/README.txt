...
DUO SDK Compilation
------------------------------------
Samples Overview - C/C++
------------------------------------

This project demonstrate simple usage of DUO with C/C++ and CMake.
...
Requirements:
	...
	2) BuildAll-x86.cmd or BuildAll-x64.cmd
	3) Run the generated exe file in the bin folder
...
http://duo3d.com/docs/articles/samples-cpp
------------------------------------